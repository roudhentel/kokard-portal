...
document.write('<script src="views/login.js"></script>');                                   // login controller
document.write('<script src="views/register.js"></script>');                                // register controller

// services
document.write('<script src="js/services/dialog.js"></script>');                            // dialog service

// directives
document.write('<script src="js/directives/dialog-template.js"></script>')                  // dialog template