...
function config($translateProvider) {
    ...
    $translateProvider
        .translations('en', {
            ...
            ALERTSANDNOTIFICATIONS: 'Alerts & Notification',
            CREDITCARDLIMITS: 'Credit Card Limits',
            CCSTATEMENTCYCLE: 'Credit Card Statement Cycle',
            SUPCARD: 'Supplementary Card',
            GRAPHS: 'Graphs',
            MAILBOX: 'Mailbox',
            WIDGETS: 'Widgets',
            METRICS: 'Metrics',
        ...
        .translations('es', {
            ...
            CARDPROGRAM: 'Programa de tarjetas',
            DASHBOARD: 'Salpicadero',
            SUMMARY: 'El Sumario',
            CARDHOLDERINFORMATION: 'Información Del Titular De La Tarjeta',
            ALERTSANDNOTIFICATIONS: 'Alertas y Notificaciones',
            SUPCARD: 'Tarjeta Suplementaria',
            CREDITCARDLIMITS: 'Límites de tarjetas de crédito',
            CCSTATEMENTCYCLE: 'Ciclo de declaración de tarjeta de crédito',
            GRAPHS: 'Gráficos',
            MAILBOX: 'El correo',
            WIDGETS: 'Widgets',
            METRICS: 'Métrica',
